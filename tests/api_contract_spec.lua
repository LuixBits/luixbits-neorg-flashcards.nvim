return function(T)
  ...
  help.close()
  local healthy, collection_cards, issues, collection_errors = flashcards.command("check")
  ...
  assert_true(type(collection_errors) == "table", "validation queries keep a stable result shape")
